...
export default function Formpop({box, close}) {
  
  return (
    <div class=" bg-neutral-400 bg-opacity-80 absolute top-0 right-0 left-0 bottom-0 flex items-center justify-between">
      <div className="h-auto md:w-3/7 mx-auto rounded-lg bg-white p-6 shadow-lg dark:bg-neutral-700">
        {box}
        <button
          type="submit"
        ...
        onClick={close}
          type="submit"
          class="inline-block w-full rounded bg-red-600 mt-4 px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-red-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-red-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-red-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]"
          data-te-ripple-init
